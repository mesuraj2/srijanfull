                    ...
                    <div className="w-[10rem] mx-auto flex flex-row items-center justify-center gap-2">
                        <div className="form-control w-[2rem] mx-auto ">
                            <input
                                ...
                                type="number"
                                name="one"
                                className={`${touched.one && !values.one ? 'bg-red-100' : 'bg-white'
                        ...
                        <div className="form-control w-[2rem] mx-auto ">
                            <input
                                ...
                                type="number"
                                name="two"
                                className={`${touched.two && !values.two ? 'bg-red-100' : 'bg-white'
                                    } input input-bordered  p-2`}
                            />
                        </div>
                        <div className="form-control w-[2rem] mx-auto ">
                            <input
                                ...
                                type="number"
                                name="three"
                                className={`${touched.three && !values.three ? 'bg-red-100' : 'bg-white'
                                    } input input-bordered  p-2`}
                            />
                        </div>
                        <div className="form-control w-[2rem] mx-auto ">
                            <input
                                ...
                                type="number"
                                name="four"
                                className={`${touched.four && !values.four ? 'bg-red-100' : 'bg-white'
                                    } input input-bordered  p-2`}
                            />
                        </div>
                    </div>
