    ...
    <div className="w-screen bg-[#B9E9FC]">
      ...
      <div className="pb-[2rem] pt-[4rem]">
        <div className="flex flex-col md:flex-row gap-5 lg:gap-10 ">
          <div className="14xl:w-[28rem] 14xl:h-[28rem] w-[16rem] h-[16rem] xs:w-[20rem] xs:h-[20rem] md:w-[24rem] md:h-[24rem] rounded-md flex flex-col items-center justify-center mx-auto md:mx-0">
          ...
          <div className=" flex flex-col gap-5 items-center justify-center md:items-start md:justify-start mt-[5rem] md:mt-10 px-2 md:px-0">
