  ...
  return (
    ...
    <main >
      ...
      <Box textAlign={'center'} mt='2rem' boxSizing='border-box' paddingY={'1rem'} >
          ...
          <Text width={'65%'} m='auto'>We are having a vast variety of products that you can choose from. We provide shopping accessories like groceries, wears for men, women and children, shoes, fashion accessories, etc. we also update regular offers for our customers for our wide variety of products.</Text>
      </Box>
