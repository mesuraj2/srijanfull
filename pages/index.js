      ...
      <div className="flex flex-col">
        <div className="flex flex-row justify-around items-center">
          ...
          <div className="flex flex-row gap-10 ">
            <Link href='/login' class="btn btn-active uppercase tracking-wider text-[1.1rem] secondary_font font-normal bg-black/90">
              LogIn
            </Link>
            <Link href={'/login?signup=true'} class="btn btn-outline tracking-wider text-[1.1rem] secondary_font font-normal">
              Sign Up
            </Link>
          </div>
        </div>
